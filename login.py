...
"")
        ...
        self.login_button.clicked.connect(self.write_user)
    ...
    def write_user(self):
        ...
        for elem in ls:
            ...
            if user[0] == self.lineEdit.text() and user[1] == self.lineEdit_2.text():
                self.label_2.setText(f"Hello {self.lineEdit.text().capitalize()}")
    ...
    def retranslateUi(self, Login):
        ...
        self.label_2.setText(QCoreApplication.translate("Login", u"<html><head/><body><p><span style=\" font-size:20pt;\">Log In</span></p></body></html>", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Login", u"Full Name", None))
        ...
        self.forgot_button.setText(QCoreApplication.translate("Login", u"", None))
